...
const PaymentDetails = () => {
	...
	return (
		<div className={c['checkout-grid-left-payment']}>
			<h4 className={c.title}>payment details</h4>

			<div className={c['checkout-grid-left-payment-top']}>
				<h5>Payment Method</h5>

				<div className={c['checkout-grid-left-payment-top-right']}>
					{methods.map((method) => (
						<div
							key={method}
							className={cn(
